function DetailPage({ movie, onBack, favorites, onFavoriteToggle }) {
    ...
    <div className="min-h-screen" style={{ background: '#0C0C0F' }}>
      ...
      <div className="relative h-96 overflow-hidden">
        <div className="absolute inset-0" style={{ 
          background: `linear-gradient(135deg, ${gradients[movie.genre]}, #1A1A1D)`,
          opacity: 0.3 
        }}></div>
          ...
          <div className="flex gap-8">
            ...
            <div className="flex-shrink-0">
              <div className="w-80 aspect-[2/3] rounded-xl overflow-hidden shadow-2xl"
                style={{ background: `linear-gradient(135deg, ${gradients[movie.genre]}, #1A1A1D)` }}
              >
            ...
            <div className="flex-1 pt-8">
              ...
              <div className="flex gap-4 mb-8">
                <button className="px-8 py-4 rounded-lg font-semibold flex items-center gap-2 transition-all hover:scale-105"
